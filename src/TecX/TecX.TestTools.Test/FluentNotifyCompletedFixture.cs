...
{
    [TestClass]
    public class FluentNotifyCompletedFixture
    {
        public FluentNotifyCompletedFixture() { }
        ...
        [TestMethod]
        public void ShouldNotifyOnCompletion()
        {
            var sut = new AsyncTestClass();

            sut.AfterCompleting(a => a.DoWork("first", "second"))
                .ShouldNotifyVia(

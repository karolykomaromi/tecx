namespace TecX.Data
{
    ...
    /// <summary>
    /// This is a stripped down version of the EntityDataReader found at <see cref="http://archive.msdn.microsoft.com/LinqEntityDataReader"/>
    /// I never had the need to deal with classes that derive from EntityObject but very often I needed to do a bulk-insert of POCOs. That was when
    /// the EntityDataReader really shone. I decided to remove all references to Entity Framework from the code. All credit goes to the original author(s)!
    /// </summary>

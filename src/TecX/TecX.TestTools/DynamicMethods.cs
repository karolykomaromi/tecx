...
namespace TecX.TestTools
{
    ...
    /// <summary>
    /// Class extracted from http://www.codeproject.com/KB/dotnet/InvokeGenericMethods.aspx
    /// </summary>
    /// <remarks>Will be moved somewhere else in the future</remarks>
    public static class DynamicMethods
    {
                                                                ...
                                                                Type[] parameterTypes)
        {
            ...
            DynamicMethod dynamicMethod = new DynamicMethod(name, typeof(object),
        ...
        private static void FindMethod(Type type, string methodName, Type[] typeArguments, Type[] parameterTypes,
            out MethodInfo methodInfo, out ParameterInfo[] parameters)
        {
            methodInfo = null;
            parameters = null;

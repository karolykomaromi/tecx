...
namespace TecX.Unity.TypedFactory
{
    public class TypedFactoryExtension : UnityContainerExtension, ITypedFactoryConfiguration
    {
            ...
            where TFactory : class
        {
            ...
            Container.RegisterType<TFactory>(new InjectionFactory((container, type, name) => GetAutoGeneratedFactory<TFactory>(container , type, name, selector)));
        }
        ...
        private TFactory GetAutoGeneratedFactory<TFactory>(IUnityContainer container, Type type, string name, ITypedFactoryComponentSelector selector)
            where TFactory : class
        {

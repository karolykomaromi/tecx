namespace TecX.ServiceModel.Unity.AutoMagic
{
    ...
    public static class WcfServiceHelper
    {
        ...
        /// <seealso cref="System.ServiceModel.Discovery.FindCriteria.Scopes"/></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Tries to get (A)ddress and (B)inding for an endpoint from <see cref="System.ServiceModel.Discovery.EndpointDiscoveryMetadata"/>
        /// </summary>
        /// <param name="contract">The contract.</param>
        /// <param name="scopes">The scopes of the endpoints to look for. <see cref="System.ServiceModel.Discovery.FindCriteria.Scopes"/></param>
        ...
        /// <see cref="System.ServiceModel.Discovery.EndpointDiscoveryBehavior.Extensions"/>
        /// </summary>
        /// <param name="metadata">The metadata.</param>

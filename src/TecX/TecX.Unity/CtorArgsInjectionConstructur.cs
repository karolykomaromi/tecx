...
{
    public class CtorArgsInjectionConstructur : InjectionMember
    {
        #region Fields
        ...
        private CtorArgsInjectionConstructur()
        {
            _ctorArguments = new Dictionary<string, object>();
        }

        public CtorArgsInjectionConstructur(string argName, object argValue)
            : this()
        {
        ...
        public CtorArgsInjectionConstructur(IEnumerable<KeyValuePair<string, object>> ctorArguments)
            : this()
        {

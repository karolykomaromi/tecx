...
namespace TecX.Unity.BuildTracking
{
    ...
    internal class DeferredResolutionTracker<T>
    {
        ...
        /// The parent node.
        /// </param>
        public DeferredResolutionTracker(Func<T> resolutionFunction, IBuildTreeStore buildTreeStore,
                                         BuildTreeItemNode parentNode)
        {
            Guard.AssertNotNull(resolutionFunction, "resolutionFunction");
            Guard.AssertNotNull(buildTreeStore, "buildTreeStore");
            Guard.AssertNotNull(parentNode, "parentNode");
        ...
        public T Resolve()
        {
            ...
            BuildTreeItemNode deferredBuildTree =
                buildTrees.Where(x => IsDeferredBuildTreeReference(x, resolvedInstance)).FirstOrDefault();
        ...
        /// The parent node.
        /// </value>
        private BuildTreeItemNode ParentNode { get; set; }
        ...
        /// The tree store.
        /// </value>
        private IBuildTreeStore TreeStore { get; set; }
    }
}
    ...
    public static class Constants
    {
        public static class Properties
        {
            ...
            public static class StoryCard
            {
                ...
                public const string CurrentSideUp = "CurrentSideUp";

                /// <summary>DescriptionHandwritingImage</summary>
                public const string DescriptionHandwritingImage = "DescriptionHandwritingImage";
            }
            ...
            public static class Iteration
            {
                ...
                public const string AvailableEffort = "AvailableEffort";

namespace Cars.I18n
{
    ...
    public class PolyglotString : IEquatable<PolyglotString>, IComparable<PolyglotString>, ICloneable<PolyglotString>
    {
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(PolyglotString));
        ...
        public static PolyglotString Format(PolyglotString ps, params object[] args)
        {
            Contract.Requires(ps != null);
            Contract.Ensures(Contract.Result<PolyglotString>() != null);
            
            var translations = ps.Translations.ToDictionary(
                kvp => kvp.Key,
                kvp => string.Format(kvp.Key, kvp.Value, PolyglotString.PreformatPolyglotStrings(kvp.Key, args)));
        ...
        private static object[] PreformatPolyglotStrings(CultureInfo culture, object[] args)
        {
            if (args == null)
            {
                return new object[0];
            ...
            object[] args2 = args.Select(
                a =>
                {
                    var ps = a as PolyglotString;

                    if (ps != null)
                    {
                        return ps.ToString(culture);
                    }

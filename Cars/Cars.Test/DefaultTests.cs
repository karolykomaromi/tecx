namespace Cars.Test
{
    ...
    public class DefaultTests
    {
        ...
        [Fact]
        public void Should_Use_None_Field_On_Class()
        {
            Assert.Same(Currency.None, Default.Value<Currency>());
        }

        [Fact]
        public void Should_Use_Invalid_Field_On_Class()
        {
            Assert.Same(Celsius.Invalid, Default.Value<Celsius>());
        }

        [Fact]
        public void Should_Use_Identity_Field_On_Class()
        {
            Assert.Same(ExchangeRate.Identity, Default.Value<ExchangeRate>());
        }

        [Fact]
        public void Should_Use_Empty_Field_On_Class()
        {
            Assert.Same(PolyglotString.Empty, Default.Value<PolyglotString>());
        }
        ...
        private class Celsius
        {
            public static readonly Celsius Invalid = new Celsius();
        }
    }
}
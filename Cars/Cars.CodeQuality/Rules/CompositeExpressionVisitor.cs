namespace Cars.CodeQuality.Rules
{
    ...
    public class CompositeExpressionVisitor : IExpressionVisitor
    {
        ...
        [SuppressMessage("DeVizor.CodeQuality.CodeQualityRules", "DV1001:MethodMustNotHaveMoreThanFourParameters", Justification = "Needed to work with StyleCop CodeWalkerElementVisitor<T>")]
        public bool Visit(
